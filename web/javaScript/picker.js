...
function showDatePickDiv() {
    document.getElementById("pickDateDiv").style.display = "block";
    document.getElementById("pickDateDivMask").style.display = "block";
}


function closeDatePickDiv() {
    document.getElementById("pickDateDiv").style.display = "none";
    document.getElementById("pickDateDivMask").style.display = "none";
}
