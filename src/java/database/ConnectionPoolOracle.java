...
public class ConnectionPoolOracle {
    ...
    private static ConnectionPoolOracle pool = null;
 ...
 */
    private ConnectionPoolOracle() {
        try {
            ...
            dataSource = (DataSource) ic.lookup("java:/comp/env/jdbc/csprod");
     ...
     */
    public static synchronized ConnectionPoolOracle getInstance() {
        if (pool == null) {
            pool = new ConnectionPoolOracle();
        }
        return pool;
    }
    ...
    public Connection getConnection() {
        try {
            ...
            ErrorLogger.log(Level.SEVERE,"Could not get a connection in ConnectionPoolOracle()", e);
            return null;
        }
    }
    ...
    public void freeConnection(Connection c) {
        ...
        try {
            c.close();
             ...
             ErrorLogger.log(Level.SEVERE,"Could not free connection in ConnectionPoolOracle()", e);
        }
    }
}