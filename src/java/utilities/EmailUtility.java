...
public class EmailUtility {
    /*
    These static variables can be used if we are sure the property manager is loaded first
    private static final String SMTP_HOST_NAME = PropertyManager.getProperty("SMTP_HOST_NAME");
    private static final String SMTP_HOST_PORT = PropertyManager.getProperty("SMTP_HOST_PORT");
    private static final String SMTP_AUTH_USER = PropertyManager.getProperty("SMTP_AUTH_USER");
    private static final String SMTP_AUTH_PWD  = PropertyManager.getProperty("SMTP_AUTH_PWD");
    */
 ...
 //           mailSession.setDebug(true); // Gives detailed output
            ...
            if(SMTP_AUTH_USER == null || !SMTP_AUTH_USER.isEmpty())
                    message.setFrom(new InternetAddress("ISISProject@bloomu.edu"));
        ...
        //   Debug.println("Adding #"+toAddress+"#");
           ...
           ErrorLogger.log(Level.SEVERE, 
             "Could not send mail in email(Collection<String> recipients, Collection<String> ccrecipients, String mailMessage, String subject)", ex);
        }
    }
    ...
    public static void email(String recipient, String mailMessage, String subject)  {
        ArrayList<String> recipients = new ArrayList<String>(1);
    ...
    public static void email(String recipient, String ccrecipient, String mailMessage, String subject)  {
        ArrayList<String> recipients = new ArrayList<String>(1);
        ArrayList<String> ccrecipients = new ArrayList<String>(1);
        recipients.add(recipient);
    ...
    public static void main(String[] args) {
        PropertyManager.configure("P:/CSProjects/ISIS/web/WEB-INF/config/General.properties");
        //PropertyManager.configure("c:/WebProjects/ISIS/web/WEB-INF/config/General.properties");
        email(   "jfp60417@huskies.bloomu.edu",
